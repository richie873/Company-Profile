export const layanan = [
  {
    ...
    content:
      "PT Kana Jaya melayani pengadaan dan pemasangan pintu serta jendela aluminium untuk rumah, gedung perkantoran, dan bangunan komersial. Dengan jangkauan layanan di Karawang, Jabodetabek, bahkan seluruh Indonesia, kami menghadirkan produk tahan karat, tampil elegan, dan minim perawatan.",
    features: [
  ...
  },
  {
    ...
    content:
      "PT Kana Jaya mengerjakan plafon gypsum, PVC, dan akustik untuk berbagai jenis bangunan. Jasa kami tersedia di Karawang, Jabodetabek, dan seluruh Indonesia dengan hasil rapi dan tahan lama.",
    features: [
  ...
  },
  {
    ...
    content:
      "Kami melayani partisi ruangan berbahan kaca, gypsum, dan movable wall untuk fleksibilitas ruang. Layanan tersedia di Karawang, Jabodetabek, dan dapat menjangkau seluruh wilayah Indonesia.",
    features: [
  ...
  },
  {
    ...
    content:
      "PT Kana Jaya melayani proyek konstruksi rangka baja untuk gudang, pabrik, dan bangunan besar lainnya. Jangkauan layanan kami mencakup Karawang, Jabodetabek, dan seluruh Indonesia.",
    features: [
  ...
  },
  {
    ...
    content:
      "PT Kana Jaya menangani pembangunan dan renovasi rumah dengan desain menyesuaikan kebutuhan Anda. Layanan ini tersedia untuk wilayah Karawang, Jabodetabek, dan dapat diperluas ke berbagai kota di Indonesia.",
    features: [
  ...
  },
  {
    ...
    content:
      "Kami membangun gudang menggunakan rangka baja dan insulasi sesuai kebutuhan industri. Layanan tersedia di Karawang, Jabodetabek, dan berbagai kota lainnya di Indonesia.",
    features: [
  ...
  },
  {
    ...
    content:
      "PT Kana Jaya mengerjakan pengaspalan dan pengecoran jalan dengan kualitas tinggi. Kami melayani berbagai proyek di Karawang, Jabodetabek, hingga seluruh wilayah Indonesia.",
    features: [
  ...
  },
  {
    ...
    content:
      "Kami merancang dan membangun saluran irigasi berbahan beton untuk lahan pertanian, perumahan, dan industri. PT Kana Jaya siap melayani proyek di Karawang, Jabodetabek, hingga daerah lain di Indonesia.",
    features: [
